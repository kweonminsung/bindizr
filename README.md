...
| `bindizr_notify_sent_total{result}` | counter | NOTIFY messages sent to secondaries, by outcome |
| `bindizr_nsupdate_requests_total{result}` | counter | RFC 2136 dynamic updates, by response code |
