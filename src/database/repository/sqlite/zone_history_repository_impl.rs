...
pub struct SqliteZoneHistoryRepository {
    pool: Pool<Sqlite>,
}

impl SqliteZoneHistoryRepository {
...
#[async_trait]
impl ZoneHistoryRepository for SqliteZoneHistoryRepository {
    async fn create(&self, mut zone_history: ZoneHistory) -> Result<ZoneHistory, String> {
        ...
        zone_history.id = result.last_insert_rowid() as i32;
        Ok(zone_history)
    }
