...
pub struct SqliteZoneDnsConfigRepository {
    pool: Pool<Sqlite>,
}

impl SqliteZoneDnsConfigRepository {
...
#[async_trait]
impl ZoneDnsConfigRepository for SqliteZoneDnsConfigRepository {
    async fn create(
        &self,
        ...
        zone_dns_config.id = result.last_insert_rowid() as i32;
