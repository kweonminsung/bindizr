...
pub async fn initialize() {
    ...
    let database_url = match database_type {
        DatabaseType::MySQL => config::get_config::<String>("database.mysql_url"),
        DatabaseType::PostgreSQL => config::get_config::<String>("database.postgres_url"),
        DatabaseType::SQLite => config::get_config::<String>("database.sqlite_url"),
    };
