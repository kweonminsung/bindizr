...
- `bindizr.dns.extraSecondaryAddrs` appends secondaries outside the chart to `dns.secondary_addrs`. Every other daemon option has a value under `bindizr.*`, rendered into the ConfigMap.
