use bindizr_service::types::{
    ...
    ExternalDnsRrset, ExternalDnsRrsetUpdate, ExternalDnsZonesResponse, GetDnssecStatusResponse,
    ...
    RolloverDnssecRequest, SecondaryStatusResponse, TsigKeyListResponse, TsigKeyResponse,
