use bindizr_service::types::{
    ...
    RollbackZoneResponse, RolloverDnssecRequest, SecondaryResponse, SecondaryStatusResponse,
    TokenGrantResponse, TokenResponse, TsigGrantResponse, TsigKeyResponse,
