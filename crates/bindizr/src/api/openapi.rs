use bindizr_service::types::{
    ...
    CreateTokenGrantRequest, CreateTsigGrantRequest, CreateTsigKeyRequest, CreateZoneRequest,
    DnssecDsInfo, DnssecDsListResponse, DnssecKeyInfo, DnssecPolicyListResponse,
    ...
    GetDnssecStatusResponse, GetRecordResponse, GetTokenGrantResponse, GetTsigGrantResponse,
    GetTsigKeyResponse, GetZoneResponse, HealthResponse, ImportMode, ImportSummary,
    ImportZoneFileRequest, ImportZoneFileResponse, MessageResponse, NotifyZoneRequest,
    PaginatedResponse, Pagination, RecordDiff, RecordDiffEntry, RecordDiffSummary, RecordDiffValue,
    RecordItem, RecordResponse, RecordValueRequest, RollbackSummary, RollbackZoneRequest,
    RollbackZoneResponse, RolloverDnssecRequest, SecondaryStatusResponse,
    SetZoneDnssecPolicyRequest, TokenGrantListResponse, TokenGrantResponse, TsigGrantListResponse,
    TsigGrantResponse, TsigKeyListResponse, TsigKeyResponse, UpdateDnssecPolicyRequest,
...
#[openapi(
    paths(
        ...
        super::token_grant::get_token_grants,
        super::token_grant::create_token_grant,
        super::token_grant::delete_token_grant,
        super::token_grant::get_zone_token_grants,
    ...
    tags(
        ...
        (name = "Token", description = "The zone grants a scoped API token holds over the record plane."),
