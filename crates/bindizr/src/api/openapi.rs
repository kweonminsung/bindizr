use bindizr_service::types::{
    ...
    SecondaryStatusResponse, TsigKeyListResponse, TsigKeyResponse, VersionDetailResponse,
    ...
    ZoneTsigPolicyListResponse, ZoneTsigPolicyResponse, ZoneVersionResponse,
};
use utoipa::{
    Modify, OpenApi,
