use bindizr_service::types::{
    ...
    CreateZoneRequest, CreatedTokenResponse, DnssecDelegationInfo, DnssecDsInfo,
    DnssecDsListResponse, DnssecKeyInfo, DnssecPolicyListResponse, DnssecPolicyResponse,
    ...
    GetZoneResponse, HealthResponse, ImportMode, ImportSummary, ImportZoneFileRequest,
    ...
    RolloverDnssecRequest, SecondaryStatusResponse, SetDnssecParentNsAddrsRequest,
    SetZoneDnssecPolicyRequest, TokenGrantListResponse, TokenGrantResponse, TokenListResponse,
    TokenResponse, TsigGrantListResponse, TsigGrantResponse, TsigKeyListResponse, TsigKeyResponse,
    UpdateDnssecPolicyRequest, VersionDetailResponse, VersionDiffResponse, VersionRecordResponse,
...
#[openapi(
    paths(
        ...
        super::dnssec::set_dnssec_parent_ns_addrs,
