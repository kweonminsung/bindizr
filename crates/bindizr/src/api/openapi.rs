use bindizr_service::types::{
    ...
    CreateSecondaryRequest, CreateTokenGrantRequest, CreateTokenRequest, CreateTsigGrantRequest,
    CreateTsigKeyRequest, CreateZoneRequest, CreatedTokenResponse, DeleteRecordsResponse,
    DeleteZoneResponse, DnssecDelegationInfo, DnssecDelegationKeyInfo, DnssecDsInfo, DnssecKeyInfo,
    ...
    GetDnssecStatusResponse, GetRecordResponse, GetSecondaryResponse, GetTokenGrantResponse,
    GetTokenResponse, GetTsigGrantResponse, GetTsigKeyResponse, GetZoneResponse, HealthResponse,
    ...
    SecondaryCheckResponse, SecondaryResponse, SecondaryStatusResponse, TokenGrantResponse,
    TokenResponse, TsigGrantResponse, TsigKeyResponse, UpdateDnssecPolicyRequest,
...
#[openapi(
    paths(
        ...
        super::notify::notify_all_zones,
        super::notify::notify_zone,
        super::secondary::list_secondaries,
        super::secondary::create_secondary,
        super::secondary::get_secondary,
        ...
        super::dnssec::update_dnssec_settings,
        super::dnssec::cancel_dnssec_withdrawal,
        super::dnssec::check_dnssec_ds,
        super::dnssec_policy::list_dnssec_policies,
        ...
        super::external_dns::list_external_dns_domains,
        super::external_dns::list_external_dns_records,
    ...
    components(schemas(
        ...
        PaginatedResponse<GetDnssecPolicyResponse>,
        PaginatedResponse<GetSecondaryResponse>,
        PaginatedResponse<GetTokenGrantResponse>,
        PaginatedResponse<GetTokenResponse>,
        PaginatedResponse<GetTsigGrantResponse>,
        PaginatedResponse<GetTsigKeyResponse>,
    ...
    tags(
        ...
        (name = "Secondary", description = "The secondary servers: each receives NOTIFY, may pull zones unsigned from its address, and is probed for the serial it serves."),
        ...
        (name = "DNSSEC", description = "DNSSEC policies (the signing-parameter bundles zones sign under) and per-zone signing: enable, disable, status, DS records for the parent zone and the parent's check of them, key rollover, and re-signing."),
